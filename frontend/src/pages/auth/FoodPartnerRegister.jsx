...
const FoodPartnerRegister = () => {
  ...
  const handleSubmit = (e) => { 
    ...
    axios.post("http://localhost:3000/api/auth/partner/register", {
      name:businessName,
      contactName,
      phone,
      email,
    ...
    <div className="auth-page-wrapper">
      <div className="auth-card" role="region" aria-labelledby="partner-register-title">
        ...
        <nav className="auth-alt-action" style={{marginTop: '-4px'}}>
          <strong style={{fontWeight:600}}>Switch:</strong> <Link to="/user/register">User</Link> • <Link to="/partner/register">Food partner</Link>
        </nav>
